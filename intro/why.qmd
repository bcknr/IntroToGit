...
Git allows you to keep track of all the versions of your analysis and track changes even when all your collaborators are working on different computers. For massive collaborative projects, like the `dplyr` package with over 250 contributors, the utility of Git-based version control might be apparent.
